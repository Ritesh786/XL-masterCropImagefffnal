 ...
 */
public class CitiesNews extends Fragment {


    private static final String TAG = CitiesNews.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cities_news, container, false);
...
//                new ColorDrawable(Color.parseColor("#1b1b1b")));
    ...
    public void populatedata(){
        ...
        final String url = Url.news+"Cities";
