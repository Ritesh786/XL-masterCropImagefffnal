...
public class DisapprovedNews extends AbsRuntimePermission implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disapproved_news);
